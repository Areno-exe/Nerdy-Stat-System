...
Start_Menu_Panel=Entity(parent=camera.ui,model='quad',color=color.dark_gray,scale=(2.5, 1),z=-20)
# -- Menu Buttons --
Start_Button=Button(parent=Start_Menu_Panel,text='Start Game',color=color.black50,scale=(0.3,0.1),position=(0,.1,-0.1))
Quit_Button=Button(parent=Start_Menu_Panel,text='Quit Game',color=color.black50,scale=(0.3,0.1),position=(0,-.1,-0.1))
...
Current_Strength=10
EXP_Strength=0
NEXT_LEVEL_Stregth=10+round(math.log(Max_Strength),3)
...
Health_Bar_bg=Entity(parent=camera.ui,model='quad',color=color.black50,scale=(0.7, 0.06),origin=(-0.5, 0),position=(-0.75,0.48,1))
...
Strength_bg=Entity(parent=camera.ui,model='quad',color='#f7952d',scale=(0.7,0.06),origin=(-0.5,0),position=(-0.75,0.36,-0.25))
...
def Defense_EXP_Update(exp):
	...
	'''
	global Max_Defense,EXP_Defense,NEXT_LEVEL_Defense,Current_Defense
